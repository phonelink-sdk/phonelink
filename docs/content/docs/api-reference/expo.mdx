...
TypeScript interface for the decoded JWT payload. This is the same type exported by all entry points. See the [Server API Reference](/api-reference/validate#phonelinkpayload) for the full property list.
