...
After receiving the result, verify the token on your server. The server-side verification is identical for web and Expo — see the [Server Verification](/docs/server) guide.
